  ...
  return (
    <>
      <div className="header flex flex-wrap justify-center" id="topLoc">
        <div className="mx-5 accounts_header rounded-xl overflow-hidden sm:px-20 pt-5 pb-10 my-10  lg:w-2/3 md:w-5/6 sm:w-full xs:w-full">
            ...
            <div className="flex justify-center text-center">
              <div className="px-4 py-5 xs:w-full sm:w-2/3">
                ...
                <blockquote className="font-semibold italic text-center text-slate-900">
                  ...
                  <p className=" md:text-2xl sm:text-xl xs:text-xl mt-3 mb-3">
                    안내를 반드시 읽고, 동의해주세요 !
                  </p>
                </blockquote>
              </div>
