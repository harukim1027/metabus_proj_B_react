          ...
          <div>
            ...
            >
              ...
              >
                ...
                {/* 첫번째 form 부분 */}
                <span className="header flex flex-wrap justify-center rounded-xl overflow-hidden  sm:w-full sm:mx-5 xs:w-full xs:mx-5 md:w-5/6 md:px-20 lg:w-2/3 pb-10 my-10">
                  {/* 신청자 이름 */}
                  <div className="my-5">
